...
# Create the pipeline with Word2Vec embeddings and GradientBoostingClassifier (GBM)
pipeline = make_pipeline(
    Word2VecTransformer(model=word2vec_model),
    GradientBoostingClassifier(n_estimators=100, learning_rate=0.1, max_depth=3, random_state=42)  # GBM model
)
...
with open('gbm_model_with_word2vec_cv.pkl', 'wb') as model_file:
...
with open('gbm_model_with_word2vec_70_30.pkl', 'wb') as model_file_70_30:
...
with open('gbm_model_with_word2vec_80_20.pkl', 'wb') as model_file_80_20:
