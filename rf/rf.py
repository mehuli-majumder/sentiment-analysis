...
# Convert text data into TF-IDF features and train the RandomForestClassifier using a pipeline
...
with open('rf_model_70_30.pkl', 'wb') as model_file_70_30:
...
with open('rf_model_80_20.pkl', 'wb') as model_file_80_20:
