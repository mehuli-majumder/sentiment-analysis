...
word2vec_model = Word2Vec.load(r"C:\Users\MEHULI MAJUMDER\OneDrive\Desktop\code stuff\bos sentiment analysis\starting afresh\rf\word2vec.model")

# Create the pipeline with Word2Vec embeddings and RandomForestClassifier
...
with open('rf_model_with_word2vec_cv.pkl', 'wb') as model_file:
...
with open('rf_model_with_word2vec_70_30.pkl', 'wb') as model_file_70_30:
...
with open('rf_model_with_word2vec_80_20.pkl', 'wb') as model_file_80_20:
